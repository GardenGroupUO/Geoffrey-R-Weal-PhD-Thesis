...
######################################################
maximum_twisting_angles = range(5,46,5)
Twisting_Axis = [0,0,1]
atoms_to_twist = [14,23,15,32]
for maximum_twisting_angle in maximum_twisting_angles:
	cluster_name = 'Au38_rotate_100_face_only_z_axis_'+str(maximum_twisting_angle)+'_degrees'
	...
	cluster_name_Opt = 'Au38_rotate_100_face_only_z_axis_'+str(maximum_twisting_angle)+'_degrees_Opt'
